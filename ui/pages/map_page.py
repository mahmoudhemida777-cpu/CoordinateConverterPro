...
class MapPage(QWidget):
    ...
    def __init__(self) -> None:
        ...
        canvas_box = QGroupBox("MAP VIEW — ALL LOADED POINTS"); canvas_box.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding); canvas_layout = QVBoxLayout(canvas_box); canvas_layout.setContentsMargins(6, 16, 6, 6)
        self.scene = QGraphicsScene(self); self.view = QGraphicsView(self.scene); self.view.setObjectName("mapCanvas"); self.view.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded); self.view.setVerticalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded); self.view.setMinimumHeight(560); self.view.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding); self.view.setTransformationAnchor(QGraphicsView.ViewportAnchor.AnchorViewCenter); self.view.setResizeAnchor(QGraphicsView.ViewportAnchor.AnchorViewCenter); canvas_layout.addWidget(self.view, 1); workbench.addWidget(canvas_box, 1)
