...
SUPPORTED_EXTENSIONS = {".kmz", ".kml", ".csv", ".xlsx", ".txt", ".xyz", ".dat", ".prn", ".asc"}
...
def find_batch_files(folder: str) -> List[Path]:
    """Recursively find supported coordinate files, case-insensitively."""
...
def run_batch(folder: str, process_one: Callable[[Path], FileResult], progress_cb: Optional[Callable[[int, int, Path], None]] = None) -> BatchReport:
